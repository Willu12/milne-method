...
% Borys Kurdek, 320704
str = "Test dokladnosci metody Rungego - Kutty" + newline;
disp(str);
...
disp(str_max_err)
% obliczenie bledow
error_calc_f(A1,b01,C1,a1,b1,n1,fun1,'R',1);
error_calc_f(A1,b01,C1,a1,b1,n1/2,fun1,'R',1);
error_calc_f(A1,b01,C1,a1,b1/2,n1/2,fun1,'R',1);
